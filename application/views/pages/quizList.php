            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-3">Quiz Results</h4>

                                <div style="width: 100%!important;">
                                    <table id="dataTable" class="table table-bordered dt-responsive nowrap" style="width: 100%!important;">
                                        <thead>
                                            <tr>
                                                <th>Sr No</th>
                                                <th>FullName</th>
